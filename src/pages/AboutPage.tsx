// ABOUTME: About page explaining the OpenVine/Rewind Web project
...
export function AboutPage() {
  return (
    <MarketingLayout>
      ...
      <ZendeskWidget />
      <h1 className="text-4xl font-bold mb-8">About Rewind</h1>

      <div className="space-y-8">
        {/* The Story */}
        <Card className="border-2 border-primary/20">
          <CardHeader>
            <CardTitle>The Story Behind Rewind</CardTitle>
          </CardHeader>
          <CardContent className="prose prose-sm dark:prose-invert max-w-none space-y-4">
            <p className="text-lg">
              In an era of AI-generated content, Rewind is a new short-form video app inspired by
            ...
            <div className="not-prose space-y-3">
              ...
              <div className="bg-muted/50 p-4 rounded-lg border">
                ...
                <div className="space-y-2">
                  ...
                  >
                    TechCrunch: Jack Dorsey funds Rewind, a Vine reboot that includes Vine's video archive
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted/50 p-4 rounded-lg border">
              <p className="text-muted-foreground">
                <strong>Important:</strong> Rewind is an independent short-form video app with no affiliation
                to X (formerly Twitter) or the original Vine platform. We're a separate project built on
                open-source technology and the decentralized Nostr protocol. Rewind preserves archived videos
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              The idea for Rewind came during interviews for the{" "}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Rewind has imported archived videos from ArchiveTeam's preservation work, giving these authentic
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground mb-4">Rewind upholds key digital rights:</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              In an era where AI can generate realistic fake videos, Rewind uses ProofMode to help you
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              ...
              Rewind brings back spontaneous, creative 6-second video sharing.
            </p>
            <p className="text-muted-foreground">
