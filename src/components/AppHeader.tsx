import { House as Home, Compass, MagnifyingGlass as Search, Bell, DotsThreeVertical as MoreVertical, Info, Code as Code2, Question as HelpCircle, Headphones, FileText, Sun, Moon, ChatCircle as MessageCircle, Plus } from '@phosphor-icons/react';
        ...
        <div className="flex items-center gap-2">
          ...
          {user && (
            <Button
              ...
              className={cn(
                "hidden md:flex items-center gap-2",
                isActive('/post') && "bg-primary text-primary-foreground"
              )}
            >
              <Plus className="h-4 w-4" weight={isActive('/post') ? 'fill' : 'bold'} />
              <span className="hidden lg:inline">{t('nav.post', { defaultValue: 'Post' })}</span>
            </Button>
          )}
